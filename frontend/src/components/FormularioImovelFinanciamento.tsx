  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div id="imovel" className="bg-white rounded-2xl p-4 sm:p-6 border border-slate-200 card-shadow space-y-4 sm:space-y-5">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
              <Building2 className="w-4 h-4 text-teal-600 flex-shrink-0" />
              1. Dados do Imóvel
            </h3>
            <span className="text-[10px] font-semibold px-2 py-0.5 rounded-md bg-teal-50 text-teal-700">
              Imóvel
            </span>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2 text-xs font-bold text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-600/20 focus:border-teal-600 transition"
              />
              {buscandoCep && (
                <RefreshCw className="w-4 h-4 animate-spin absolute right-3 top-2.5 text-teal-600" />
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2 text-xs text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-600/20 focus:border-teal-600 transition"
              />
              <button
                type="button"
          ...
          {resultadoBusca && (
            <div className="bg-teal-50/60 border border-teal-100 rounded-xl p-3 space-y-1.5 text-xs">
              <div className="flex items-center justify-between text-teal-900 font-bold">
                ...
                <span className="text-xs font-extrabold text-teal-700 bg-white px-2 py-0.5 rounded-md border border-teal-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs uppercase font-bold"
              />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-9 pr-3 py-2 text-xs font-semibold text-slate-900"
                />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-9 pr-3 py-2 text-xs font-bold text-teal-700"
                />
              </div>
            </div>
          </div>
        ...
        <div id="financiamento" className="bg-white rounded-2xl p-4 sm:p-6 border border-slate-200 card-shadow space-y-4 sm:space-y-5">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
              <Landmark className="w-4 h-4 text-teal-600 flex-shrink-0" />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pr-8 pl-3 py-2 text-xs font-semibold text-slate-900"
                />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-bold text-teal-700"
              />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-xl pl-9 pr-3 py-2 text-xs font-bold text-slate-900 focus:ring-2 focus:ring-teal-500/20"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-xl pl-9 pr-3 py-2 text-xs font-bold text-teal-700"
                />
              </div>
            </div>
          </div>
