import { converterTaxaAnualParaMensal, SistemaAmortizacao } from "./calculo-financiamento";
import { calcularCenarioVenda, ParametrosVenda, ResultadoVenda } from "./regras-fiscais";
